...
EcoMug for the data for different types of partilces. The codes for
the header Files and source files are given below in figure-\ref{gunheader}
and figure-\ref{gunsouorce}
...
\begin{figure}[H]
    \centering	
     \includegraphics[width=\columnwidth]{gunheader.png}
     \caption{Code For the Header File for fParticleGun}
     \label{gunheader}
\end{figure}

\begin{figure}[H]
    \centering	
     \includegraphics[width=\columnwidth]{gunsource.png}
     \caption{Code For the Source File for fParticleGun}
     \label{gunsouorce}
\end{figure}


\section{Single Particle Generation}
