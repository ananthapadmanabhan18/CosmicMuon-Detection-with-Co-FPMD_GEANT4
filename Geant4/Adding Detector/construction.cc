...
G4VPhysicalVolume *scintillation1::Construct()
{
    ...
    G4LogicalVolume* logicalDetector = new G4LogicalVolume(solidDetector, ge, "Detector1");
    ...
    // G4Polyhedra *gassfill = new G4Polyhedra("gas", phiStart,phiTotal,numSide,numZplanes,zPlanes,gInner, gOuter);
