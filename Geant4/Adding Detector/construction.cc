...
G4VPhysicalVolume *scintillation1::Construct()
{
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0, 0, 0), logicalDetector1, "Detector1", logicworld, false, 0,true);
    ...
    new G4PVPlacement(nullptr, G4ThreeVector(0, 2*m,0), logicalDetector2, "Detector2", logicworld, false, 0,true);
