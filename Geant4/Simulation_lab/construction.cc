...
G4VPhysicalVolume *scintillation1::Construct()
{
    ...
    G4Material* argongas = new G4Material("argon_only", 1.72*g/L , 1);
    argongas->AddElement(argonGas,1);
    ...
    G4LogicalVolume* gaslogic = new G4LogicalVolume(solidDetector, argongas, "Detector1");
    new G4PVPlacement(nullptr, G4ThreeVector(0, 15*mm, -11.5*cm), gaslogic, "Detector1", logicworld, false, 0,checkoverlap);
