...
histogram = ROOT.TH1F("histogram", "Plot of Frequency  vs Energy Deposit  (GeV)", 750, 0, 0.01)
...
landau_func = ROOT.TF1("landau_func", "landau", 0,0.004)
